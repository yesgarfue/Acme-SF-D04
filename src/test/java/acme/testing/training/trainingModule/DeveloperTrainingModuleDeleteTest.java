...
public class DeveloperTrainingModuleDeleteTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/developer/trainingModule/delete-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/developer/trainingModule/delete-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	public void test300Hacking() {
		...
		super.request("/developer/training-module/delete");
