...
<acme:form>
	<acme:input-integer code="sponsor.dashboard.label.totalNumInvoicesWithTaxLessOrEqualTo21" path="totalNumInvoicesWithTaxLessOrEqualTo21" placeholder=""/>
	<acme:input-integer code="sponsor.dashboard.label.totalNumInvoicesWithLink" path="totalNumInvoicesWithLink" placeholder=""/>
