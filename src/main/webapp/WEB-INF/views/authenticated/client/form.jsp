...
<acme:form>
	...
	placeholder="authenticated.client.form.identification.placeholder"/>
	<acme:input-textbox code="authenticated.client.form.label.companyName" path="companyName"/>
	<acme:input-select code="authenticated.client.form.label.clientType" path="clientType" choices="${types}"/>
