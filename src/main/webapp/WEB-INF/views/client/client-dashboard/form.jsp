...
<table class="table table-sm">
	<tr>
		...
		<td>
			<acme:print value="${progressLogsBelow25}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
		...
		<td>
			<acme:print value="${progressLogsBetween25And50}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
		...
		<td>
			<acme:print value="${progressLogsBetween50And75}"/>
		</td>
	</tr>
	<tr>
		<th scope="row">
		...
		<td>
			<acme:print value="${progressLogsAbove75}"/>
		</td>
	</tr>
	</table>
...
<jstl:forEach var="currency" items="${supportedCurrencies}">
    ...
    <table class="table table-sm">
        <tr>
            ...
            <td>
                <acme:print value="${averageBudgetPerCurrency[currency]}"/>
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <acme:print value="${deviationBudgetPerCurrency[currency]}"/>
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <acme:print value="${minimumBudgetPerCurrency[currency]}"/>
            </td>
        </tr>   
        <tr>
            <th scope="row">
            ...
            <td>
                <acme:print value="${maximumBudgetPerCurrency[currency]}"/>
            </td>
        </tr>
    </table>
</jstl:forEach>