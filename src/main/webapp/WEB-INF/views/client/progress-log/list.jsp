...
<acme:list>
	...
	<acme:list-column code="client.progressLog.list.label.completenessPercentage" path="completenessPercentage" width="20%"/>
...
<acme:button code="client.progressLog.button.create" action="/client/progress-log/create"/>